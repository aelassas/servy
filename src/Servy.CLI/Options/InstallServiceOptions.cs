...
namespace Servy.CLI.Options
{
    ...
    public class InstallServiceOptions : GlobalOptionsBase
    {
        ...
        /// Optional.
        /// </summary>
        [Option("user", HelpText = "The service account username (e.g., .\\username, DOMAIN\\username, or DOMAIN\\gMSA$ for Group Managed Service Accounts). Make sure to grant full access on C:\\ProgramData\\Servy to NT AUTHORITY\\NetworkService, NT AUTHORITY\\LocalService, or whichever account runs the service.")]
