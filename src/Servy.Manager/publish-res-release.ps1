...
.DESCRIPTION
    ...
    in Release configuration and produces a self-contained single-file executable.
    The resulting executable and PDB files are copied into the Servy.Manager Resources folder.
    Optional core and infrastructure PDBs can also be copied if needed (currently commented out).
...
.EXAMPLE
    ...
    Publishes Servy.Service using the default framework and copies artifacts to Servy.Manager Resources folder.
