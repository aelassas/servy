...
namespace Servy.Core.Services
{
    ...
    {
        /// <summary>
        /// Executes a WMI query and returns the matching <see cref="ManagementObject"/> instances.
        /// </summary>
        ...
        /// </param>
        /// <returns>An <see cref="IEnumerable{ManagementObject}"/> containing the WMI objects that match the query.</returns>
        IEnumerable<ManagementObject> Get(string query, CancellationToken cancellationToken = default);
    }
}
