...
namespace Servy.Core.Native
{
    ...
    public static partial class NativeMethods
    {
        ...
        /// Handles domain accounts, local accounts, and group Managed Service Accounts (gMSA).
        /// </summary>
        /// <param name="username">The account name (e.g., DOMAIN\User or .\User).</param>
        /// <param name="password">The account password (optional for gMSA).</param>
