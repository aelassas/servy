...
namespace Servy.Core.Config
{
    ...
    public static class AppConfig
    {
        ...
        /// </summary>
        public static readonly string Version = "8.1";
        ...
        /// </summary>
        public static readonly string ConfigurationAppPublishDebugPath = Path.Combine(ServyServiceUIDebugFolder, "Servy.exe");
        ...
        /// </summary>
        public static readonly string DefaultConnectionString = $"Data Source={Path.Combine(DbFolderPath, "Servy.db")};Busy Timeout=5000;Journal Mode=WAL;";
