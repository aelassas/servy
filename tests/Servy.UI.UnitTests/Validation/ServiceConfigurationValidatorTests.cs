...
namespace Servy.UI.UnitTests.Validation
{
    ...
    public class ServiceConfigurationValidatorTests
    {
        ...
        public async Task ValidateAsync_ValidationFails_ShowsErrorWithInjectedCaption()
        {
            ...
            // Act
            var isValid = await validator.ValidateAsync(new ServiceDto(), cancellationToken: CancellationToken.None);
        ...
        public async Task ValidateAsync_WhenConfigurationIsValid_ReturnsTrueAndDoesNotShowMessage(bool importMode)
        {
            ...
            // Act
            var result = await _validator.ValidateAsync(dto, importMode: importMode, cancellationToken: CancellationToken.None);
        ...
        {
            // Arrange, Act
            var result = await _realRulesValidator.ValidateAsync(null, cancellationToken: CancellationToken.None);
        ...
        public async Task ValidateAsync_ValidationFails_ShowsErrorAndReturnsFalse()
        {
            ...
            // Act
            var result = await _realRulesValidator.ValidateAsync(dto, cancellationToken: CancellationToken.None);
        ...
        public async Task ValidateAsync_PasswordMismatch_ShowsErrorAndReturnsFalse()
        {
            ...
            var result = await _realRulesValidator.ValidateAsync(dto, confirmPassword: "DifferentPassword", cancellationToken: CancellationToken.None);
        ...
        public async Task ValidateAsync_WithExplicitWrapperExePath_EvaluatesRulesAndReturnsTrue()
        {
            ...
            var result = await _realRulesValidator.ValidateAsync(dto, wrapperExePath: wrapperExePath, confirmPassword: null, cancellationToken: CancellationToken.None);
