    ...
    public static class ServiceDtoFactory
    {
        ...
        public static ServiceDto CreateFull(string suffix = "")
        {
            return new ServiceDto
            {
                ...
                CpuAffinity = string.IsNullOrEmpty(suffix) ? "0-3" : "0,2,4",
                ...
                HeartbeatUrl = string.IsNullOrEmpty(suffix) ? "http://localhost:9000/health" : "https://health.example.com/probe",
                HeartbeatUrlTimeoutSeconds = string.IsNullOrEmpty(suffix) ? 5 : 15,
