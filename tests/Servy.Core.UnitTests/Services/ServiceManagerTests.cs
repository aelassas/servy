    ...
    public class ServiceManagerTests : IDisposable
    {
        ...
        public async Task InstallService_OptionsNull_ThrowsArgumentNullException()
        {
            ...
            var exception = await Assert.ThrowsAsync<ArgumentNullException>(() =>
                _serviceManager.InstallServiceAsync(null, cancellationToken: CancellationToken.None));
        ...
        {
            // Arrange
            var validScmHandle = _handles.Scm(123);
        ...
        private Func<ServiceDto> ArrangeSuccessfulInstallAndCaptureDto()
        {
            ...
            _mockServiceRepository.Setup(x => x.UpsertAsync(
                ...
                .Callback<ServiceDto, bool, bool, CancellationToken>((dto, preserveRuntimeState, preserveCredentials, token) => captured = dto)
                .ReturnsAsync(1);
        ...
        public async Task InstallService_UnicodeCasingVariance_SuccessfullyPurgesLegacyVariant()
        {
            ...
            var scmHandle = _handles.Scm(123);
            var legacyServiceHandle = _handles.Service(456);
            var targetServiceHandle = _handles.Service(789);
        ...
        public async Task InstallService_UnexpectedException_DatabaseRecoveryThrows_ReturnsFailureResultWithoutPanic()
        {
            ...
            {
                result = await _serviceManager.InstallServiceAsync(options, CancellationToken.None);
            });
        ...
        {
            // Arrange
            _mockWindowsServiceApi.Setup(x => x.OpenSCManager(null, null, It.IsAny<uint>())).Returns(_handles.Scm(0));
        ...
        public async Task StartService_ShouldReturnTrue_WhenAlreadyRunning()
        {
            ...
            // Act
            var result = await _serviceManager.StartServiceAsync("TestService", cancellationToken: CancellationToken.None);
        ...
        public async Task StopService_ShouldReturnTrue_WhenAlreadyStopped()
        {
            ...
            // Act
            var result = await _serviceManager.StopServiceAsync("TestService", cancellationToken: CancellationToken.None);
        ...
        public async Task RestartService_ShouldStopAndStart_AndRefreshStatus()
        {
            ...
            // Act
            var result = await _serviceManager.RestartServiceAsync("TestService", cancellationToken: CancellationToken.None);
        ...
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() => _serviceManager.GetServiceStatus(serviceName, CancellationToken.None));
            Assert.Equal("serviceName", exception.ParamName);
        }
        ...
        public void IsServiceInstalled_ReturnsTrue_WhenServiceExists()
        {
            ...
            // Act & Assert
            Assert.True(_serviceManager.IsServiceInstalled("MyService", CancellationToken.None));
        }
        ...
        public void IsServiceInstalled_ReturnsFalse_WhenServiceMissing()
        {
            ...
            // Act & Assert
            Assert.False(_serviceManager.IsServiceInstalled("MyService", CancellationToken.None));
        }
        ...
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() => _serviceManager.IsServiceInstalled(serviceName, CancellationToken.None));
            Assert.Equal("serviceName", exception.ParamName);
        }
        ...
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() => _serviceManager.GetServiceStartupType(serviceName, CancellationToken.None));
            Assert.Equal("serviceName", exception.ParamName);
        }
            ...
            ServiceStartType expected)
        {
            ...
            var scmHandle = _handles.Scm(1);
            var svcHandle = _handles.Service(2);
        ...
        public void GetServiceStartupType_ShouldReturnAutomatic_WhenExceptionOccurs()
        {
            ...
            // Act
            var result = _serviceManager.GetServiceStartupType("AnyService", CancellationToken.None);
        ...
        public void GetAllServices_ShouldThrowWin32Exception_WhenSCManagerFailsToOpen()
        {
            ...
            // Act & Assert
            Assert.Throws<Win32Exception>(() => _serviceManager.GetAllServices(CancellationToken.None));
        }
        ...
        public void GetAllServices_ShouldReturnEmpty_WhenNoServicesFound()
        {
            ...
            _mockWindowsServiceApi.Setup(x => x.OpenSCManager(null, null, It.IsAny<uint>())).Returns(_handles.Scm(1));
        ...
        {
            // Arrange
            var svcHandle = _handles.Service(1);
            var mockSvc = new Mock<IServiceControllerWrapper>();
            mockSvc.Setup(s => s.ServiceName).Returns("TestSvc");
            mockSvc.Setup(s => s.Status).Returns(ServiceControllerStatus.Running);
            mockSvc.Setup(s => s.StartType).Returns(ServiceStartMode.Manual);
        ...
        public void GetDependencies_ShouldReturnDependencies()
        {
            ...
            // Act
            var result = _serviceManager.GetDependencies("TestService", CancellationToken.None);
        ...
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() => _serviceManager.GetDependencies(serviceName, CancellationToken.None));
            Assert.Equal("serviceName", exception.ParamName);
        }
        ...
        public void GetDependencies_ControllerThrows_ShouldPropagateException()
        {
            ...
            // Act & Assert
            Assert.Throws<InvalidOperationException>(() => _serviceManager.GetDependencies("TestService", CancellationToken.None));
        ...
        public void GetDependencies_ShouldDisposeController()
        {
            ...
            // Act
            _serviceManager.GetDependencies("TestService", CancellationToken.None);
