...
namespace Servy.UnitTests.Services
{
    public class ServiceCommandsTests : IDisposable
    {
        ...
        public ServiceCommandsTests()
        {
            ...
            // Default service presence check to false so InstallService tests proceed by default
            _serviceManagerMock.Setup(m => m.IsServiceInstalled(It.IsAny<string>(), It.IsAny<CancellationToken>()))
                .Returns(false);
        ...
        public async Task InstallService_MissingWrapperExe_ReturnsFalseAndDisplaysError()
        {
            ...
            try
            {
                ...
                // Act
                var result = await sut.InstallServiceAsync(dto, cancellationToken: CancellationToken.None);
        ...
        public async Task InstallService_DtoNullFallback_ReturnsFalse()
        {
            ...
            // Act
            var result = await sut.InstallServiceAsync(null, cancellationToken: CancellationToken.None);
        ...
        public async Task InstallService_RunAsLocalSystem_MasksUserAccountAndCredentials()
        {
            ...
            // Act
            await sut.InstallServiceAsync(dto, confirmPassword: "abc", runAsLocalSystem: true, cancellationToken: CancellationToken.None);
        ...
        public async Task InstallService_OperationCanceled_PropagatesInsteadOfMasking()
        {
            ...
            await Assert.ThrowsAsync<OperationCanceledException>(
                () => sut.InstallServiceAsync(dto, cancellationToken: CancellationToken.None));
        ...
        public async Task UninstallService_OperationCanceled_PropagatesInsteadOfMasking()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<OperationCanceledException>(
                () => sut.UninstallServiceAsync(serviceName, CancellationToken.None));
        ...
        public async Task ExecuteServiceCommand_StartService_OperationCanceled_PropagatesInsteadOfMasking()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<OperationCanceledException>(
                () => sut.StartServiceAsync(serviceName, CancellationToken.None));
        ...
        public async Task OpenManager_OperationCanceled_PropagatesInsteadOfMasking()
        {
            ...
            try
            {
                // Act & Assert
                await Assert.ThrowsAsync<OperationCanceledException>(
                    () => sut.OpenManagerAsync(cancellationToken: CancellationToken.None));
        ...
        public async Task ExportConfig_OperationCanceled_PropagatesInsteadOfMasking()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<OperationCanceledException>(
                () => sut.ExportXmlConfigAsync("password", cancellationToken: CancellationToken.None));
