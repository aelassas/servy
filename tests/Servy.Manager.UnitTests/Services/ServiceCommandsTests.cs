...
namespace Servy.Manager.UnitTests.Services
{
    public class ServiceCommandsTests : IDisposable
    {
        ...
        public async Task ConfigureServiceAsync_TargetOutsideAppDirectory_RefusesToLaunch()
        {
            ...
            {
                // Act
                await sut.ConfigureServiceAsync(new Service { Name = "TestService" }, CancellationToken.None);
        ...
        public async Task StartServiceAsync_ShouldCallServiceManager()
        {
            ...
            // Act
            var result = await sut.StartServiceAsync(service, cancellationToken: CancellationToken.None);
        ...
        public async Task StopServiceAsync_ShouldCallServiceManager()
        {
            ...
            // Act
            var result = await sut.StopServiceAsync(service, cancellationToken: CancellationToken.None);
        ...
        public async Task RestartServiceAsync_ShouldCallServiceManager()
        {
            ...
            // Act
            var result = await sut.RestartServiceAsync(service, cancellationToken: CancellationToken.None);
